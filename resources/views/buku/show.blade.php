...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Breadcrumb -->
        <nav class="flex text-sm text-gray-600 mb-8">
                    ...
                    <div class="mt-auto">
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                            <p class="text-yellow-800 text-sm">
                                ...
                                Silakan login terlebih dahulu untuk membeli buku ini
                            </p>
                        </div>
                        <a href="{{ route('login') }}" class="block w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition font-semibold text-center">
                            Login untuk Membeli
                        </a>
                    </div>
                    @endguest
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden">
                    <a href="{{ route('buku.show', $related->id_buku) }}">
                    ...
                    <div class="p-4">
                        <a href="{{ route('buku.show', $related->id_buku) }}" class="hover:text-blue-600">
